...
export const Campaigns: React.FC = () => {
  ...
  const categories = Array.from(new Set(campaignAssets.map(a => a.category).filter(Boolean)));
  ...
  return (
    <div className="pb-24 pt-0 px-4 max-w-md mx-auto min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      <div className="sticky top-0 z-[100] bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100/50 dark:border-gray-800/50 -mx-4 px-4 py-3 mb-3 transition-all shadow-2xl dark:shadow-none">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold ml-2 text-gray-900 dark:text-white tracking-tight">Campaigns</h1>
          </div>
        </div>
      </div>
