  ...
  return (
    <div className="relative h-screen bg-gray-900 overflow-hidden flex flex-col justify-between max-w-md mx-auto">
      ...
      <div className="z-10 pb-12 px-8 text-white">
        ...
        <button 
          onClick={next}
          className="w-full bg-synergy-blue text-white font-semibold py-4 rounded-full flex items-center justify-center space-x-2 shadow-glow active:scale-95 transition-transform hover:bg-synergy-dark"
        >
