...
import { ArrowLeft, MessageCircle, Phone, Copy, Check, UserCheck, UserPlus, Search, X, Scan } from 'lucide-react';
...
export const ReferrerInfo: React.FC = () => {
  const { referrer, addReferrer, language, showToast } = useApp();
