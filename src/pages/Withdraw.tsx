...
export const Withdraw: React.FC = () => {
            ...
            <div className="flex-1 px-6 flex flex-col items-center justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="w-full bg-white dark:bg-gray-900 rounded-[28px] p-6 shadow-2xl dark:shadow-none border border-gray-100 dark:border-gray-800 space-y-5">
                    ...
                    <div className="bg-synergy-blue/5 dark:bg-synergy-blue/10 rounded-xl p-3 flex justify-between items-center border border-synergy-blue/10">
                        <span className="text-[10px] font-black text-synergy-blue uppercase tracking-widest">{t('withdraw.net')}</span>
                    ...
                    <div className="p-6 relative z-10">
                        ...
                        <div className="space-y-6 mb-6">
                            <div className="flex flex-col items-center py-3 border-y border-gray-50 dark:border-gray-800/50">
                                <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1">{t('withdraw.net')}</span>
  ...
  return (
    <div className="pb-10 pt-0 px-4 max-w-md mx-auto min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative font-sans">
      {isProcessing && (
