...
import { Mail, Lock, ArrowLeft, ArrowRight, Gift, X, User, Phone, ShieldCheck, Smartphone, Eye, EyeOff, Check, FileText, Circle, KeyRound, RefreshCw, Loader2, Sparkles, AlertCircle, TrendingUp } from 'lucide-react';
      ...
      return (
          <div className="w-full bg-white dark:bg-gray-900 p-8 rounded-[40px] shadow-2xl dark:shadow-none relative animate-in fade-in duration-500">
              ...
              <div className="flex flex-col items-center">
                  <div className="w-14 h-14 bg-blue-50 dark:bg-blue-900/20 text-synergy-blue rounded-2xl flex items-center justify-center mb-4 shadow-sm">
                      <Smartphone size={28} />
                  </div>
      ...
      <div className="bg-white dark:bg-gray-900 p-8 rounded-[40px] shadow-2xl dark:shadow-none relative z-10 border border-white/50 dark:border-gray-800 transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-2 mt-8">
            ...
            <div className="space-y-1 animate-in slide-in-from-top-2 duration-300">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl py-2.5 pl-12 pr-4 text-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-synergy-blue/20 transition text-sm font-medium"
                  required={!isLogin}
                />
              </div>
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              {emailOrPhone.match(/^[0-9]+$/) ? <Smartphone className="absolute left-4 top-3 text-gray-300" size={18} /> : <Mail className="absolute left-4 top-3 text-gray-300" size={18} />}
              <input 
                type="text" 
                value={emailOrPhone}
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="••••••••"
                className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl py-2.5 pl-12 pr-12 text-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-synergy-blue/20 transition text-sm font-medium"
                required
              />
              <button 
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-4 top-3 text-gray-400 hover:text-synergy-blue transition"
              >
          ...
          {!isLogin && (
            <div className="space-y-1 animate-in slide-in-from-top-2 duration-300">
              ...
              <div className="relative">
                <ShieldCheck className="absolute left-4 top-3 text-gray-300" size={18} />
                <input 
                  type={showPassword ? "text" : "password"} 
                      ...
                      <div className="space-y-6">
                          <div>
                              ...
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  Your account is protected by industry-standard encryption. Commission tracking is automated via our proprietary Synergy Flow engine to ensure 100% accuracy on every direct and team referral. Any attempt to manipulate the system will result in immediate account suspension.
                              </p>
                          </div>
                          <div>
                              <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest mb-2 flex items-center"><TrendingUp size={14} className="mr-2 text-amber-500" /> 2. Commission & Tiers</h4>
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  Commissions are paid based on your current Affiliate Tier (Starter, Marketer, Builder, Executive). Rates vary from 5% up to 30% for direct referrals, with additional indirect team bonuses. Same-tier commissions are limited to one level only to maintain system sustainability.
                              </p>
                          </div>
                          <div>
                              <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest mb-2 flex items-center"><Check size={14} className="mr-2 text-synergy-blue" /> 3. Payout & Verification</h4>
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  Withdrawals are enabled only for KYC-verified members. The system automatically audits all sales before releasing funds to prevent fraud. Minimum withdrawal amounts and processing times apply as stated in the Finance section.
                              </p>
                          </div>
                          <div>
                              <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest mb-2 flex items-center"><AlertCircle size={14} className="mr-2 text-red-500" /> 4. Prohibited Activities</h4>
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  Spamming, misleading advertisements, creating multiple accounts for self-referral, or any unethical marketing practices are strictly prohibited. Violation of these rules will lead to permanent termination of your affiliate status and forfeiture of pending commissions.
                              </p>
                          </div>
                          <div>
                              <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest mb-2 flex items-center"><User size={14} className="mr-2 text-purple-500" /> 5. Data Privacy & Integrity</h4>
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  We prioritize your privacy. Personal and banking data are used strictly for payout processing and tax compliance. By joining, you agree to provide accurate information and keep your contact details up to date.
                              </p>
                          </div>
                          <div>
                              <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-widest mb-2 flex items-center"><RefreshCw size={14} className="mr-2 text-blue-500" /> 6. Agreement Updates</h4>
                              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                  Synergy Flow reserves the right to modify these terms, commission rates, or tier requirements at any time. Members will be notified of significant changes via the platform's notification system.
                              </p>
                          </div>
                      </div>
                  </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                placeholder="••••••••"
                                className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl py-2.5 pl-12 pr-12 text-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-synergy-blue/20 transition text-sm font-medium"
                                required
                            />
                            <button 
                                type="button"
